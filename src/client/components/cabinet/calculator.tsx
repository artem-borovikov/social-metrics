        ...
        {formIsSaved ? (
          <div className="success">
            ...
            <ul>
              {form.childrenCount && (
                <>
                  <li>Единовременное пособие при рождении ребёнка</li>
                  <li>
                    Единовременное пособие при передаче ребёнка на воспитание в
                    семью
                  </li>
                  <li>
                    Ежемесячное пособие по уходу за ребёнком по достижении им
                    1,5 лет
                  </li>
                  <li>
                    Ежемесячные выплаты по уходу за ребёнком в возрасте от 1,5
                    до 3 лет
                  </li>
                  <li>Ежемесячные выплаты на ребёнка от 3 до 7 лет</li>
                  <li>
                    Ежемесячное пособие на ребёнка в возрасте от 8 до 17 лет
                  </li>
                  <li>
              ...
              {form.childrenCount > 2 && (
                <>
                  <li>Выдача удостоверения многодетной семьи</li>
                  <li>Выделение земельного участка многодетной семье</li>
                  <li>
                    Орден «Родительская слава» и денежное поощрение к нему 450
                    000₽ для погашения ипотеки
                  </li>
                </>
              )}
            </ul>
